...
import 'package:toriyose_app/page/consumable_store.dart';
/*
void main() {
  //runApp(ProviderScope(child: App()));
  runApp(InAppPurchase());
}
*/
...
const String _kConsumableId =
    'com.wixsite.otoriyosegurume11n.toriyose.point.100';
const String _kConsumableId2 =
    'com.wixsite.otoriyosegurume11n.toriyose.point.200';
...
const List<String> _kConsumableIds = [
  _kConsumableId,
  _kConsumableId2,
];
...
class _MyAppState extends State<_MyApp> {
  ...
  Card _buildProductList() {
    ...
    print("purchases:" + purchases.length.toString());
